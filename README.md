# Apptension Website 2017

Created using Apptension's react boilerplate [Apptension React Boilerplate](https://github.com/apptension/react-boilerplate.)

## Quick start

1. Clone this repo using:
  ```shell
  $ git clone git@bitbucket.org:apptension/apptension-site-2017.git
  ```
